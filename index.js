...
const parseArgv = (args) => {
    return yargs(args)
        ...
        .version()
        .option('donate', {
            describe: 'My ERC20 wallet 0x638c613ccad9160a991ebc6d8a74a23186b4671c aka DOXUTA (via BSC to lower gas fee)'
        })
        .help('help')
        .argv
}
...
const printDonate = () => {
    if (cluster.isPrimary) {
        console.log('========================')
        console.log('If you like my work, donate me a coffee too 0x638c613ccad9160a991ebc6d8a74a23186b4671c (ENS: doxuta)')
